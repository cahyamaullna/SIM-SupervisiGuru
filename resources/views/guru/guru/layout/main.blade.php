...
<div class="tooltip tooltip-left" data-tip="Anda Terjadwal">
    ...
    @section('tabs')
    <div class="tabs mt-8">
        <a class="tab tab-lg tab-border-none tab-lifted {{ request()->is('guru') ? 'tab-active' : ''}}" href="/guru">Berkas</a>
        <a class="tab tab-lg tab-border-none tab-lifted {{ request()->is('guru/jadwal') ? 'tab-active' : ''}}" href="/guru/jadwal">Lihat Jadwal</a>
        <a class="tab tab-lg tab-border-none tab-lifted cursor-default"></a>
    </div>

    <div class="h-fit bg-white shadow-xl rounded-2xl p-8 border-1 {{ request()->is('guru') ? 'rounded-tl-none' : ''}}">
